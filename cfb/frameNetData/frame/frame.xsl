                            ...
                            <xsl:if test='@coreType="Core"'>
                                <tr>
                                    <td valign='top' width='210' cellpadding='4'>
                                        ...
                                        <xsl:if test="fn:semType/@name!=''">
                                            <br/>
                                            <b style='font-size:14px'>Semantic Type:</b>
                                            <xsl:for-each select='fn:semType'>
                                                <xsl:value-of select="@name"/>
                                                <xsl:if test='position()!=last()'>,</xsl:if>
                                            </xsl:for-each>
                                        ...
                                        <xsl:if test="fn:requiresFE/@name!=''">
                                            <br/>
                                            <b style='font-size:14px'>Requires:</b>
                                        ...
                                        <xsl:if test="fn:excludesFE/@name!=''">
                                            <br/>
                                            <b style='font-size:14px'>Excludes:</b>
                    ...
                    <xsl:if test="$internalMode!='desktop'">
                        <table class='sortable' cellspacing='10' margin-left='auto' margin-right='auto'>
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:">
                                        <b>Lexical Entry Report</b>
                                    </a>
                                </td>
                                <td>
                                    <a href="javascript:">
                                        <b>Annotation Report</b>
                                    </a>
                                </td>
                                <td>
                                    <a href="javascript:">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <xsl:if test='@status!="Problem"'>
                                            <a href='../lu/lu{$luID}.xml?mode=lexentry' target='_parent'>Lexical entry
                                            </a>
                                        </xsl:if>
                                    </td>
                                    <td>
                                        <xsl:if test='fn:sentenceCount/@annotated>0 and @status!="Problem"'>
                                            <a href='../lu/lu{$luID}.xml?mode=annotation' target='_parent'>Annotation
                                            </a>
                                        </xsl:if>
                                    </td>
                                    <td>
                                        <xsl:value-of select='@cBy'/>
                                    </td>
                                    <td>
                                        <xsl:value-of select='@cDate'/>
                                    </td>
